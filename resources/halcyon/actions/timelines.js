...
export const refreshAccountTimeline            = accountId => refreshTimeline(`account:${accountId}`, `/api/v1/accounts/${accountId}/statuses`, { exclude_replies: true });
export const refreshAccountMediaTimeline       = accountId => refreshTimeline(`account:${accountId}:media`, `/api/v1/accounts/${accountId}/statuses`, { only_media: true });
export const refreshAccountTimelineWithReplies = accountId => refreshTimeline(`account:${accountId}:with_replies`, `/api/v1/accounts/${accountId}/statuses`);
